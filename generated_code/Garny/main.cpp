...
void runMethods(double savingRate, int nThreads, int eqType){
    ...
    Stopwatch watch;
    Solveode *addt = new Solveode(0.01, 0.1, eqType);
...
//     system("ps aux | grep ./main");
    ...
    Stopwatch watch2;
    Solveode *addt2 = new Solveode(0.1, 0.1, eqType);
...
// 	system("gnuplot graph.plt > lixo.out");
// 	system("rm lixo.out");
