#ifndef _CML_tentusscher_model_2006_M_pe_
#define _CML_tentusscher_model_2006_M_pe_
...
void __equation__pe_(Solveode *classe)
{
    ...
    const double var_L_type_Ca_current__i_CaL = (((3.98e-05 * var_L_type_Ca_current_d_gate__d * var_L_type_Ca_current_f_gate__f * var_L_type_Ca_current_f2_gate__f2 * var_L_type_Ca_current_fCass_gate__fCass * 4.0 * (var_membrane__V - 15.0) * 9309421124.37) * 3.87974901066e-07) * ((0.25 * var_calcium_dynamics__Ca_ss * exp((2.0 * (var_membrane__V - 15.0) * 96485.3415) * 3.87974901066e-07)) - 2.0)) / (exp((2.0 * (var_membrane__V - 15.0) * 96485.3415) * 3.87974901066e-07) - 1.0);
    var_membrane__i_CaL = var_L_type_Ca_current__i_CaL;
    const double var_sodium_potassium_pump_current__i_NaK = ((2.298375 * var_sodium_dynamics__Na_i) / (var_sodium_dynamics__Na_i + 40.0)) / (1.0 + (0.1245 * exp(( -0.1 * var_membrane__V * 96485.3415) * 3.87974901066e-07)) + (0.0353 * exp(((-var_membrane__V) * 96485.3415) * 3.87974901066e-07)));
    ...
    const double var_sodium_calcium_exchanger_current__i_NaCa = (1000.0 * ((exp((0.35 * var_membrane__V * 96485.3415) * 3.87974901066e-07) * pow(var_sodium_dynamics__Na_i, 3.0) * 2.0) - (exp(( -0.65 * var_membrane__V * 96485.3415) * 3.87974901066e-07) * 2744000.0 * var_calcium_dynamics__Ca_i * 2.5))) / (3413921.875 * 3.38 * (1.0 + (0.1 * exp(( -0.65 * var_membrane__V * 96485.3415) * 3.87974901066e-07))));
    ...
    const double var_potassium_pump_current__i_p_K = (0.0146 * (var_membrane__V - var_reversal_potentials__E_K)) / (1.0 + exp((25.0 - var_membrane__V) * 0.167224080268));
    ...
    const double d_dt_rapid_time_dependent_potassium_current_Xr1_gate__Xr1 = ((1.0 / (1.0 + exp(( -26.0 - var_membrane__V) * 0.142857142857))) - var_rapid_time_dependent_potassium_current_Xr1_gate__Xr1) / (1.0 * (450.0 / (1.0 + exp(( -45.0 - var_membrane__V) * 0.1))) * (6.0 / (1.0 + exp((var_membrane__V + 30.0) * 0.0869565217391))));
    const double d_dt_rapid_time_dependent_potassium_current_Xr2_gate__Xr2 = ((1.0 / (1.0 + exp((var_membrane__V + 88.0) * 0.0416666666667))) - var_rapid_time_dependent_potassium_current_Xr2_gate__Xr2) / (1.0 * (3.0 / (1.0 + exp(( -60.0 - var_membrane__V) * 0.05))) * (1.12 / (1.0 + exp((var_membrane__V - 60.0) * 0.05))));
    const double d_dt_slow_time_dependent_potassium_current_Xs_gate__Xs = ((1.0 / (1.0 + exp(( -5.0 - var_membrane__V) * 0.0714285714286))) - var_slow_time_dependent_potassium_current_Xs_gate__Xs) / ((1.0 * (1400.0 / sqrt(1.0 + exp((5.0 - var_membrane__V) * 0.166666666667))) * (1.0 / (1.0 + exp((var_membrane__V - 35.0) * 0.0666666666667)))) + 80.0);
    const double d_dt_fast_sodium_current_m_gate__m = ((1.0 / pow(1.0 + exp(( -56.86 - var_membrane__V) * 0.110741971207), 2.0)) - var_fast_sodium_current_m_gate__m) / (1.0 * (1.0 / (1.0 + exp(( -60.0 - var_membrane__V) * 0.2))) * ((0.1 / (1.0 + exp((var_membrane__V + 35.0) * 0.2))) + (0.1 / (1.0 + exp((var_membrane__V - 50.0) * 0.005)))));
    const double d_dt_fast_sodium_current_h_gate__h = ((1.0 / pow(1.0 + exp((var_membrane__V + 71.55) * 0.134589502019), 2.0)) - var_fast_sodium_current_h_gate__h) / (1.0 / (((var_membrane__V <  -40.0) ? (0.057 * exp((-(var_membrane__V + 80.0)) * 0.147058823529)) : 0.0) + ((var_membrane__V <  -40.0) ? ((2.7 * exp(0.079 * var_membrane__V)) + (310000.0 * exp(0.3485 * var_membrane__V))) : (0.77 / (0.13 * (1.0 + exp((var_membrane__V + 10.66) *  -0.0900900900901)))))));
    const double d_dt_fast_sodium_current_j_gate__j = ((1.0 / pow(1.0 + exp((var_membrane__V + 71.55) * 0.134589502019), 2.0)) - var_fast_sodium_current_j_gate__j) / (1.0 / (((var_membrane__V <  -40.0) ? ((((( -25428.0 * exp(0.2444 * var_membrane__V)) - (6.948e-06 * exp( -0.04391 * var_membrane__V))) * (var_membrane__V + 37.78)) * 1.0) / (1.0 + exp(0.311 * (var_membrane__V + 79.23)))) : 0.0) + ((var_membrane__V <  -40.0) ? ((0.02424 * exp( -0.01052 * var_membrane__V)) / (1.0 + exp( -0.1378 * (var_membrane__V + 40.14)))) : ((0.6 * exp(0.057 * var_membrane__V)) / (1.0 + exp( -0.1 * (var_membrane__V + 32.0)))))));
    const double d_dt_L_type_Ca_current_d_gate__d = ((1.0 / (1.0 + exp(( -8.0 - var_membrane__V) * 0.133333333333))) - var_L_type_Ca_current_d_gate__d) / ((1.0 * ((1.4 / (1.0 + exp(( -35.0 - var_membrane__V) * 0.0769230769231))) + 0.25) * (1.4 / (1.0 + exp((var_membrane__V + 5.0) * 0.2)))) + (1.0 / (1.0 + exp((50.0 - var_membrane__V) * 0.05))));
    const double d_dt_L_type_Ca_current_f_gate__f = ((1.0 / (1.0 + exp((var_membrane__V + 20.0) * 0.142857142857))) - var_L_type_Ca_current_f_gate__f) / ((1102.5 * exp((-pow(var_membrane__V + 27.0, 2.0)) * 0.00444444444444)) + (200.0 / (1.0 + exp((13.0 - var_membrane__V) * 0.1))) + (180.0 / (1.0 + exp((var_membrane__V + 30.0) * 0.1))) + 20.0);
    const double d_dt_L_type_Ca_current_f2_gate__f2 = (((0.67 / (1.0 + exp((var_membrane__V + 35.0) * 0.142857142857))) + 0.33) - var_L_type_Ca_current_f2_gate__f2) / ((562.0 * exp((-pow(var_membrane__V + 27.0, 2.0)) * 0.00416666666667)) + (31.0 / (1.0 + exp((25.0 - var_membrane__V) * 0.1))) + (80.0 / (1.0 + exp((var_membrane__V + 30.0) * 0.1))));
    ...
    const double d_dt_transient_outward_current_s_gate__s = ((1.0 / (1.0 + exp((var_membrane__V + 20.0) * 0.2))) - var_transient_outward_current_s_gate__s) / ((85.0 * exp((-pow(var_membrane__V + 45.0, 2.0)) * 0.003125)) + (5.0 / (1.0 + exp((var_membrane__V - 20.0) * 0.2))) + 3.0);
    const double d_dt_transient_outward_current_r_gate__r = ((1.0 / (1.0 + exp((20.0 - var_membrane__V) * 0.166666666667))) - var_transient_outward_current_r_gate__r) / ((9.5 * exp((-pow(var_membrane__V + 40.0, 2.0)) * 0.000555555555556)) + 0.8);
